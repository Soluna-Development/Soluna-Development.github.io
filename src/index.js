document.addEventListener('DOMContentLoaded', () => {
    ...
    const faqs = [
        { q: 'How do I get whitelisted?', a: 'Join our Discord server and follow the instructions in the whitelist channel to get access.' },
        { q: 'Where can I report bugs and suggest features?', a: 'Head over to our Discord server — there are dedicated channels for bug reports and feature suggestions.' },
        ...
        { q: "I can't close the GUI. How can I fix it?", a: 'Try using the designated toggle keybind, or reopen the executor and reinject the script.' },
        ...
        { q: 'How do I review the script?', a: 'You can leave a review through our Discord server once you have used the script.' },
    ];
